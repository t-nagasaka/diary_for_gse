Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "diary_for_gse_production"
  ...
  sg_user_name = Rails.application.credentials.sendgrid[:user_name]
  sg_password = Rails.application.credentials.sendgrid[:password]
